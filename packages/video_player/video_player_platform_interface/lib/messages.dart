...
class FullScreenMessage {
  ...
  Map<dynamic, dynamic> _toMap() {
    final Map<dynamic, dynamic> pigeonMap = <dynamic, dynamic>{};
    pigeonMap['textureId'] = textureId;
    pigeonMap['fullscreen'] = fullscreen;
    return pigeonMap;
  }
  // ignore: unused_element
  static FullScreenMessage _fromMap(Map<dynamic, dynamic> pigeonMap) {
    ...
    result.textureId = pigeonMap['textureId'];
    result.fullscreen = pigeonMap['fullscreen'];
    return result;
  }
}
...
class VideoPlayerApi {
  ...
  Future<void> setFullScreen(FullScreenMessage arg) async {
    final Map<dynamic, dynamic> requestMap = arg._toMap();
    const BasicMessageChannel<dynamic> channel =
        BasicMessageChannel<dynamic>('dev.flutter.pigeon.VideoPlayerApi.setFullScreen', StandardMessageCodec());
