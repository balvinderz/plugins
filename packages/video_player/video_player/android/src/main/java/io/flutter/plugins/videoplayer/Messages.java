...
public class Messages {
  ...
  public static class FullScreenMessage {
    ...
    public void setFullscreen(Boolean setterArg) { this.fullscreen = setterArg; }

    HashMap toMap() {
      HashMap<String, Object> toMapResult = new HashMap<String, Object>();
      toMapResult.put("textureId", textureId);
      toMapResult.put("fullscreen", fullscreen);
      return toMapResult;
    }
    static FullScreenMessage fromMap(HashMap map) {
      FullScreenMessage fromMapResult = new FullScreenMessage();
      fromMapResult.textureId = (map.get("textureId") instanceof Integer) ? (Integer)map.get("textureId") : (Long)map.get("textureId");
      fromMapResult.fullscreen = (Boolean)map.get("fullscreen");
      return fromMapResult;
    }
  }
  ...
  public interface VideoPlayerApi {
    ...
    void setFullScreen(FullScreenMessage arg);
    ...
    public static void setup(BinaryMessenger binaryMessenger, VideoPlayerApi api) {
      ...
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<Object>(binaryMessenger, "dev.flutter.pigeon.VideoPlayerApi.setMixWithOthers", new StandardMessageCodec());
        if (api != null) {
          channel.setMessageHandler(new BasicMessageChannel.MessageHandler<Object>() {
            public void onMessage(Object message, BasicMessageChannel.Reply<Object> reply) {
      ...
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<Object>(binaryMessenger, "dev.flutter.pigeon.VideoPlayerApi.setFullScreen", new StandardMessageCodec());
        if (api != null) {
          channel.setMessageHandler(new BasicMessageChannel.MessageHandler<Object>() {
            public void onMessage(Object message, BasicMessageChannel.Reply<Object> reply) {
              FullScreenMessage input = FullScreenMessage.fromMap((HashMap)message);
              HashMap<String, HashMap> wrapped = new HashMap<String, HashMap>();
              try {
                api.setFullScreen(input);
                wrapped.put("result", null);
              }
              catch (Exception exception) {
                wrapped.put("error", wrapError(exception));
